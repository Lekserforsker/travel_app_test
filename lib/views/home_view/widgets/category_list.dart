...
class _CategoryListState extends State<CategoryList> {
  ...
  Widget build(BuildContext context) {
    return Consumer<HomeViewmodel>(
      builder: (context, homeViewmodelm, child) {
        return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
              homeViewmodelm.categorie,
            ...
            Container(
              ...
              child: ListView.separated(
                ...
                itemCount: homeViewmodelm.categories.length,
                ...
                itemBuilder: (context, index) => InkWell(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        SvgPicture.asset(
                          homeViewmodelm.categories[index].path,
                          color: index == activeIndex
                              ? AppColor.taWhiteFFFFFF
                        ...
                        Text(
                          homeViewmodelm.categories[index].title.toString(),
